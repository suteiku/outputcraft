 ...
 */
export default function CubeMark({ height = 30, className = '' }) {
  return (
    <svg
      viewBox="11 5 78 90"
      height={height}
    ...
    >
      <defs>
        <linearGradient id="cm-top" x1="88" y1="6" x2="12" y2="28" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#FF5C00" />
          <stop offset="100%" stopColor="#FF7A30" />
        </linearGradient>
        <linearGradient id="cm-right" x1="0" y1="28" x2="0" y2="94" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#CC4A00" />
          <stop offset="100%" stopColor="#A33A00" />
        </linearGradient>
        <linearGradient id="cm-left" x1="0" y1="28" x2="0" y2="94" gradientUnits="userSpaceOnUse">
      ...
      {/* Left face — darkest */}
      <polygon points="12,28 50,50 50,94 12,72" fill="url(#cm-left)" />

      {/* Right face */}
      <polygon points="88,28 88,72 50,94 50,50" fill="url(#cm-right)" />

      {/* Top face — orange */}
      <polygon points="50,6 88,28 50,50 12,28" fill="url(#cm-top)" />

      {/* Precision grid on top face */}
      <g clipPath="url(#cm-clip)" stroke="white" strokeWidth="0.7" fill="none">
      ...
      {/* Edge lines — dark seams between faces for crisp 3D separation */}
      ...
      {/* Outer silhouette — thin dark seam */}
      <polygon
